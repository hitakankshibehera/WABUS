...
export const MargPointsModal: React.FC<MargPointsModalProps> = ({ isOpen = true, onClose }) => {
  ...
  const handleCopyReferral = () => {
    if (!referral) return;
    navigator.clipboard.writeText(referral.referralLink || `https://margpath.vercel.app/?ref=${referral.code}`);
              ...
              <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs flex items-center gap-1.5 transition cursor-pointer shrink-0"
                  >
